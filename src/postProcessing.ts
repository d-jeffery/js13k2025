...
import {
    ASSERT,
    engineAddPlugin, glCanvas, glContext,
    glCreateProgram,
    glCreateTexture,
    glEnable,
    glFlush, glGeometryBuffer,
    headlessMode, mainCanvas, mainContext, overlayCanvas, time
} from "littlejsengine";
 ...
 *  @memberof PostProcessPlugin */
export function initPostProcess(shaderCode, includeOverlay=false)
{
